...
result_dir = "./Simulation_results/Simulation_1/EM_results/K3N200r1tr1"
...
ratio = 1
D_total = 1000
D_genotype = round(D_total * ratio / (ratio + 1))
print(D_genotype)
...
for K in range(2, 7):
    ...
    print(f"Running EM for K = {K}", flush=True)
